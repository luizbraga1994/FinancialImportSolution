...
public sealed class DatabaseSeeder
{
    ...
    private async Task SeedDefaultSystemSettingsAsync(CancellationToken cancellationToken)
    {
        ...
        var defaults = new List<SystemSetting>
        {
            ...
            new() { Chave = "Aparencia:CorSidebar",     Categoria = "Aparencia", TipoDado = "color",  Obrigatorio = false, Valor = "#1a0a0a",          Descricao = "Cor de fundo do menu lateral (sidebar)" },
            ...
            new() { Chave = "Aparencia:CorPrimaria",    Categoria = "Aparencia", TipoDado = "color",  Obrigatorio = false, Valor = "#dc2626",          Descricao = "Cor primaria (botoes, links ativos, destaques)" },
